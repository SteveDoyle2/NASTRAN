...
C        
  ...
  190 FORMAT (6X,4A4,'CURVE',I9,4H(--,,I2,')')        
  200 FORMAT (6X,4A4,'CURVE',I9,'(',I2,4H,--))        
  210 FORMAT (' ')        
  ...
  240 FORMAT (6X,64HXY-PAIRS BETWEEN XMIN AND XMAX WILL BE PUNCHED BIGIN
     1NING ON CARD,I8)        
  250 FORMAT (//5X,'THIS IS CURVE',I4,4H OF ,A4,A2,'FRAME',I5)        
  ...
  330 FORMAT (//25X,69HP R I N T E D   D A T A   F O R   T H I S   C U R
     1 V E   F O L L O W S)        
  340 FORMAT (//5X,4A4,12HCURVE   ID =,I9,5X,'COMPONENT =',I3,5X,A4,A2,
  ...
  380 FORMAT (6X,'PLOTTER SPECIFIED IS ',3A4,A1,9H PLOTTER ,2A4,       
     1        'TYPING CAPABILITY.')
  390 FORMAT (6X,'PAPER SIZE ',F5.2,3H X ,F5.2,' INCHES SPECIFIED.')  
