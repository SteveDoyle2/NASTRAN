...
C        
 1960 IF (START .EQ. IUNST) GO TO 1980        
      CALL PAGE2 (-6)        
      WRITE  (OP,1965)        
 1965 FORMAT ('0',/,'0  + INDICATES DMAP INSTRUCTIONS THAT ARE PROCESS',
...
C        
 2160 IF (BKDATA .LT. 0) CALL PAGE2 (-2)        
      ...
      WRITE  (OP,2161)        
 2161 FORMAT ('0',10X,'**COMPILATION COMPLETE - JOB TERMINATING WITH ', 
     1       'NOGO STATUS**')        
      GO TO 2175        
 2165 IF (BKDATA .GE. 0) GO TO 2175        
      WRITE  (OP,2170)        
 2170 FORMAT ('0',10X,'**NO ERRORS FOUND - EXECUTE NASTRAN PROGRAM**')  
      GO TO 2175        
 2171 WRITE  (OP,2172)        
 2172 FORMAT ('0',9X,'**NO ERRORS FOUND - NASTRAN EXECUTION TERMINATED',
     1        ' BY USER REQUEST**')        
      GO TO 3000        
C        
...
C        
 ...
 2180 FORMAT (' ',/5X,22HFIAT AT END OF PREFACE,3I15, /,' ',/5X,'EQUIV',
 ...
 2191 FORMAT ('+',48X,3I20)        
 2192 FORMAT ('+',48X,6I10)        
 2200 CONTINUE        
 ...
 2220 FORMAT (9X,'1,   XVPS    ,   FLAGS = 0,   REEL =  1,   FILE =',I7)
      ...
      NLINES = NLINES + 3        
      WRITE  (OP,2230)        
 2230 FORMAT (9X,'CONTINUATION OF CHECKPOINT DICTIONARY', /,' ')        
      WRITE  (OP,2220) I        
      GO TO 3000        
...
C        
 ...
 2350 FORMAT ('0  OPTIONS IN EFFECT ',2A4,A3,'=',I1,3X,8A4,/3X,17('-'), 
     1        /)        
      KDLH = 1        
      GO TO 2042        
C        
